  ...
  return (
    <div className="flex lg:flex-row flex-col ">
      ...
      <div className="flex-1 flex-col">
        <h1 className={"text-3xl lg:text-6xl pt-10 pl-10 font-bold " + (inria.className)}>
          ABOUT US
        </h1>
        <p className="text-xl lg:text-3xl pl-10 pt-2">What makes us unique?</p>
        <p className={"text-md lg:text-xl pl-10 pr-10 pt-5 " + (inria2.className)}>
